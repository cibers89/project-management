  ...
  return (
    <div className="h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="relative h-full">
        {/* ================= SIDEBAR (OVERLAY, NO PUSH) ================= */}
        <aside
          className={`fixed top-0 left-0 z-40 h-screen bg-black text-white transition-all duration-300 ${
        ...
        {/* ================= CONTENT (FIXED WIDTH, NO SHIFT) ================= */}
        <main className="absolute inset-0 pl-16 overflow-y-auto">
